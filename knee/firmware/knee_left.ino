/*
 * knee_left.ino
 * PASS LEFT knee module - XIAO ESP32-S3 + 2x BNO085 -> WiFi UDP stream.
 * Identical to knee_right.ino except UNIT_ID - flash this onto the board
 * mounted on the LEFT leg.
 *
